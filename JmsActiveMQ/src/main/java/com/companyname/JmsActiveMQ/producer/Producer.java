package com.companyname.JmsActiveMQ.producer;
...
public class Producer {
	...
	public void convertToJSON(@RequestParam("file") MultipartFile myFile)
			throws IOException {
		{
			File XmlFile;
	...
	public static File convert(MultipartFile file) throws IOException { // converting multipartfile to file
